...
class _ChatScreenState extends State<ChatScreen> implements BridgefyDelegate {
  final BridgefyService _bridgefyService = BridgefyService();
  final TextEditingController _messageController = TextEditingController();
  final ScrollController _scrollController = ScrollController();

  // App state
  MeshConnectionStatus _connectionStatus = MeshConnectionStatus.disconnected;
  ...
  Future<void> _checkAndRequestPermissions() async {
    ...
    setState(() => _connectionStatus = MeshConnectionStatus.connecting);
    ...
    try {
      ...
      setState(() {
        ...
        if (!granted) {
          _connectionStatus = MeshConnectionStatus.error;
  ...
  Future<void> _sendMessage() async {
    if (_connectionStatus != MeshConnectionStatus.connected) {
  ...
  void _updateConnectedPeers() async {
    if (_connectionStatus != MeshConnectionStatus.connected) return;
            ...
            ListTile(
              ...
              onTap: () async {
                ...
                setState(() {
                  ...
                  _permissionsGranted = false;
                  _connectionStatus = MeshConnectionStatus.disconnected;
                });
              ...
              children: [
                Icon(
                  _isInitializing
                      ...
                      : _connectionStatus == MeshConnectionStatus.connected
                          ? Icons.wifi
                          : _connectionStatus == MeshConnectionStatus.connecting
                              ? Icons.wifi_off
                              : Icons.error,
